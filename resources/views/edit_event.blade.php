            ...
            <form method="POST" action="/event_modify" onsubmit="return check(this)">
                ...
                <div class = "form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="start_date"  @if($start_date != '1970-01-01') value="{{$start_date}}" @endif type="date" class="form-control @error('date') is-invalid @enderror" name="start_date" value="{{ old('start_date') }}" autofocus>

                        <input id="start_time" @if($start_date != '1970-01-01') value="{{$start_time}}" @endif type="time" class="form-control @error('time') is-invalid @enderror" name="start_time" value="{{ old('start_time') }}" autofocus>
                ...
                <div class = "form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="end_date" @if($end_date != '1970-01-01') value="{{$end_date}}" @endif type="date" class="form-control @error('date') is-invalid @enderror" name="end_date" value="{{ old('end_date') }}" autofocus>
                        <input id="end_time" @if($end_date != '1970-01-01') value="{{$end_time}}" @endif type="time" class="form-control @error('end_time') is-invalid @enderror" name="end_time" value="{{ old('end_time') }}" autofocus>
