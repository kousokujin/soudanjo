        ...
        <div class="card-body">
            <form method="POST" action="newquest_register" onsubmit="return check(this)">
                ...
                <div class = "form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="start_date" type="date" class="form-control @error('date') is-invalid @enderror" name="start_date" value="{{ old('start_date') }}" autofocus>
                        <input id="start_time" type="time" class="form-control @error('time') is-invalid @enderror" name="start_time" value="{{ old('start_time') }}" autofocus>
                ...
                <div class = "form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="end_date" type="date" class="form-control @error('date') is-invalid @enderror" name="end_date" value="{{ old('end_date') }}" autofocus>
